...
import { HomeOutlined, Home, AssignmentOutlined, Assignment, PersonOutlined, Person, Add } from '@mui/icons-material';
...
const Navbar = () => {
    ...
    const NavItem = ({ page, filledIcon, outlinedIcon }: { page: PagesEnum, filledIcon: any, outlinedIcon: any }) => {
        const path = `/${page}`;
